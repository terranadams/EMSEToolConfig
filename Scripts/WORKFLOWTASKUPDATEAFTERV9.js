...
if (bzr) {
	...
	var useCustomScriptFileFalse = false;
	eval(getScriptText2("INCLUDES_ACCELA_GLOBALS",null,useCustomScriptFileFalse));
...
function getScriptText(vScriptName, servProvCode, useProductScripts) {
	...
	aa.print("vScriptName: " + vScriptName + " useProductScripts: " +useProductScripts);
	try {
...
function getScriptText2(vScriptName, servProvCode, useProductScripts) {
	if (!servProvCode)  servProvCode = aa.getServiceProviderCode();
	vScriptName = vScriptName.toUpperCase();
	var emseBiz = aa.proxyInvoker.newInstance("com.accela.aa.emse.emse.EMSEBusiness").getOutput();
	aa.print("vScriptName: " + vScriptName + " useProductScripts: " +useProductScripts);
