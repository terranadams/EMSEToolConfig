...
/* ISA  */  //var eventName = "InspectionMultipleScheduleAfter" ; inspType = "Roofing"
...
try {
	showDebug = true;
	for (i=1;i<50000; i++) {
		updateTask("Application Submittal", "Complete", "1. Comment from EMSE script","1. Lonnnn Note from EMSE script....very long very long 64 chars");
	}
	for (i=1;i<50000; i++) {
		updateTask("Prevention Review", "Approved", "1. Comment from EMSE script","1. Lonnnn Note from EMSE script....very long very long 64 chars");
	}
