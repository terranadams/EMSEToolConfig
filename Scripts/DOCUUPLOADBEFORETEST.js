...
try {
	...
	showMessage = true;
showDebug=true;
	    comment("You must enter a valid State Liquor Authority License Number to continue." + AInfo['NYS License Serial Number']);
...
if (debug.indexOf("**ERROR") > 0)
	...
	if (cancel)
		...
		if (showMessage) aa.env.setValue("ErrorMessage", "DocumentUpdateBefore: ErrorCode=-2 showMessage =true " + message);
