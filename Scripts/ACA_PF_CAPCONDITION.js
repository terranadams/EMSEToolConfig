...
aa.capCondition.createCapConditionFromStdCondition(capId, 12349);
aa.capCondition.createCapConditionFromStdCondition(capId, 12398);
aa.capCondition.createCapConditionFromStdCondition(capId, 12399);
