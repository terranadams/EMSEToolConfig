...
var inspTimeArr = aa.env.getValue("InspectionTimeArray");
var inspAMPMArr = aa.env.getValue("InspectionAMPMArray");
var inspDateArr = aa.env.getValue("InspectionDateArray");

var t1 = aa.env.getValue("PermitId1");
var t2 = aa.env.getValue("PermitId2");
var t3 = aa.env.getValue("PermitId3");

var resultCapIdStringSave = null;

/* emes1 = "s_id1 : " + s_id1.length;
emes2 = "| s_id2 : " + s_id2.length;
emes3 = "| s_id3 : " + s_id3.length;
emes4 = "| inspIdArr : " + inspIdArr.length;
emes5 = "| inspTimeArr : " + inspTimeArr.length;
emes6 = "| inspDateArr : " + inspDateArr.length;

emesFinal = emes1 + emes2 + emes3 + emes4 + emes5 + emes6;
test2 = t1 + " : " + t2 + " : " + t3;

email("msbowen@columbus.gov","BZS_noreply@columbus.gov","TestISA",emesFinal);
email("msbowen@columbus.gov","BZS_noreply@columbus.gov","TestISA_2",test2); */
...
for (thisElement in s_id1)
	...
	r.inspTimeA = inspTimeArr[thisElement];
	r.inspAMPM = inspAMPMArr[thisElement];
	r.inspDateA = inspDateArr[thisElement];
