/*------------------------------------------------------------------------------------------------------/
| Program : PaymentApplyAfter
| Event   : PaymentApplyAfter
|
| Usage   : No productized master script available, and event does not directly expose capID object
|
|
| Notes   : Adapted from UniversalMasterScriptV3.0.js
|
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
//This event sets the wrong variable name - provide the one global include wants
aa.env.setValue("CapId", aa.env.getValue("CapIdModel"));
