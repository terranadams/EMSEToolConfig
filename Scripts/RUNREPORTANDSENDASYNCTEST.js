...
aa.print("in aa events script run report reportName : " + reportName  + " report params: " + reportParameters );
...
var success = sendReport();
	aa.sendMail(systemMailFrom, "esheridan@accela.com", "", "Enterring Evnet Script initial", success);
...
function sendReport() {
	...
	//	aa.print("From RunReport: " + report);
	//		aa.sendMail(systemMailFrom, "esheridan@accela.com", "", "line 95", report.getOutput() + " parameters: " + reportParameters);
	...
	//		aa.sendMail(systemMailFrom, "esheridan@accela.com", "", "line 113", report.getOutput() + " parameters: " + reportParameters + " capIDString " + capIDString  " reportResult: " +reportResult.getErrorType() + ":" + reportResult.getErrorMessage());			
			return false;
		}
		...
		if (!matches(emailTo,null,"",undefined)) {
			var result = null;
		//	result = aa.document.sendEmailByTemplateName(emailFrom, emailTo, emailCC, emailTemplate, emailParameters, rFiles);
			...
			aa.print("what is result Type: " + result.getClass());
