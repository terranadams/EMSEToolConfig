...
| Action# : N/A
|
| Notes   : Customized 11/28/2017: failsafe in case inspObj.getScheduledDate() or inspObj.getInspectionStatusDate() null, default today. (#17ACC-264985)
| 
|
|
/------------------------------------------------------------------------------------------------------*/
...
if (inspId > 0) // if we have fixed the parameter problem
	...
	//Replaced these 2 lines from standard master script:
...
/-----------------------------------------------------------------------------------------------------*/
showDebug=true;
logDebug("doScripts: " + doScripts);
logDebug("doStdChoices: " + doStdChoices);
logDebug("new master script");
