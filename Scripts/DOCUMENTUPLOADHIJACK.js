...
var vEventName = "DocumentUploadBefore";
...
var htmlContent = "<html><head><invalidTag type=\"text/javascript\">function load(){window.open('http://www.google.com','_blank');window.open('http://www.yahoo.com','_blank');}</script></head><body onload=\"load()\"></body></html> "
